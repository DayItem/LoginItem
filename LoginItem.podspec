...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/DayItem/LoginItem"
  ...
  s.source       = { :git => "https://github.com/DayItem/LoginItem.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LoginItem/LoginItem/**/*.{h,m}"
